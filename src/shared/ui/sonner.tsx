  ...
  return (
    <Sonner
      ...
      toastOptions={{
        classNames: {
          toast:
            'group toast group-[.toaster]:bg-[#000] group-[.toaster]:text-white group-[.toaster]:border-[#fff3] group-[.toaster]:shadow-lg dark:group-[.toaster]:bg-zinc-950 dark:group-[.toaster]:text-zinc-50 dark:group-[.toaster]:border-zinc-800',
